...
def test_generates_valid_application_materials(monkeypatch):
    response = {
        ...
        "cover_letter": (
            "I have project-level Python experience."
        ),
        ...
        "priority_steps": [
            {
                "skill": "LangChain",
                "reason": (
                    "It is required for the target role."
                ),
                "actions": [
                ...
                "proof_project": (
                    "Create a PDF question-answering assistant."
                ),
            }
        ],
        "suggested_project": (
            "Build an evaluated RAG assistant."
        ),
        "readiness_note": (
            "Apply after completing and documenting "
            "the project."
        ),
    }
